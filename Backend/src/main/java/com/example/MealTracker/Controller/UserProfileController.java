...
public class UserProfileController {
    ...
    @PostMapping
    public UserProfileDto createProfile(@RequestBody @Validated UserProfileDto dto) {
    ...
    public ResponseEntity<UserProfileDto> getProfileForDate(@PathVariable @Validated String date){
